...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  return {
    paths: items.map((p) => ({ params: { slug: p.fm.slug } })),
    fallback: false,
  }
}
...
/* ======================
   Page
====================== */
export default function BackstageSlugPage({
  post,
  latest,
  mostRead,
  contact,
  ...
  const url = absoluteUrl(`/backstage/${post.fm.slug}`)
